          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div variants={itemVariants} className="space-y-5">
              <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
                Hey! I&apos;m <strong className="text-gray-900 dark:text-white">{siteConfig.name}</strong> — a 
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                My flagship project, <strong className="text-primary-600 dark:text-primary-400">TournaHub</strong>,
              ...
              <div className="grid grid-cols-3 gap-4 pt-4">
                {[
                  ...
                  <div
                    key={stat.label}
                    className="text-center p-4 rounded-xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800"
                  >
            ...
            <motion.div variants={containerVariants} className="grid grid-cols-2 gap-4">
              {values.map(({ icon: Icon, title, description }) => (
                ...
                >
                  <div className="w-10 h-10 rounded-xl bg-primary-50 dark:bg-primary-950/50 flex items-center justify-center mb-3 group-hover:bg-primary-100 dark:group-hover:bg-primary-900/50 transition-colors">
