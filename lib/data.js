...
export const siteConfig = {
  ...
  description:
    'Full Stack Developer passionate about crafting high-performance web applications with clean, maintainable code.',
  email: 'dan@albatrossdan.dev',
  ...
  social: {
    ...
    email: 'mailto:dan@albatrossdan.dev',
  },
};
...
export const projects = [
  {
    ...
    demo: '',
    featured: true,
    image: null, // Set to an image path in /public if available
    category: 'Full Stack',
    status: 'In Progress',
  },
  {
